...
VALUES (1, 50.00, 1, 4), (2, 50.00, 3, 5), (3, 50.00, 4, 3), (4, 50.00, 2, 3), (5, 50.00, 4, 3), (6, 50.00, 4, 2), (7, 50.00, 4, 2), (24, 50.00, 4, 2), (25, 50.00, 4, 2), (27, 50.00, 4, 2), (28, 50.00, 4, 2), (29, 50.00, 4, 2), (30, 50.00, 4, 2), (41, 50.00, 4, 2), (42, 50.00, 4, 2), (43, 50.00, 4, 2), (48, 50.00, 4, 2), (50, 50.00, 4, 2);
...
CREATE PROCEDURE VERIFIER_ET_METTRE_A_JOUR_ETAT() BEGIN 
	UPDATE planning
	SET etat = 'Effectuer'
	WHERE
	    datehf < NOW()
...
CREATE EVENT METTRE_A_JOUR_ETAT 
	...
	DO
	CALL
	    verifier_et_mettre_a_jour_etat();
