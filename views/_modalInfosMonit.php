<!-- Modal -->
<div class="modal fade" id="modalInfosMonit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Changement du mot de passe</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="" method="post">
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" id="old_password" name="old_password" placeholder="Ancien mot de passe" aria-label="Ancien mot de passe" aria-describedby="basic-addon2" required>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" id="new_password" name="new_password" placeholder="Nouveau mot de passe" aria-label="Nouveau mot de passe" aria-describedby="basic-addon2" required>
                        <div class="input-group-append">
                    ...
                    <select name="security_question" id="" class="form-select pointer mb-3" required>
                    ...
                    <input class="form-control" type="text" placeholder="Réponse de sécurité" name="security_answer" required>
            </div>
            <div class="modal-footer">
                <button type="Close" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                <button type="Submit" class="btn btn-primary" id="MonitInfosChange" name="MonitInfosChange">Modifier</button>
                </form>
            </div>
        </div>
    </div>
